        ...
        for str in lst:
            ...
            while move > 0:
                ...
                if second is True and (curX, curY) in cordinates and cordinates[(curX, curY)] != (0, 0):
                    dist = manhattan_distance((origX, origX), (curX, curY))

                    if dist != 0 and (curX, curY) in cordinates and (steps + cordinates[(curX, curY)]) < stepsDone:
                        stepsDone = steps + cordinates[(curX, curY)]

                    if dist != 0 and dist < minDistance:
                        minDistance = dist

                if second is False:
                    cordinates[(curX, curY)] = steps
        second = True
    return minDistance, stepsDone
